				...
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						<li>
							...
							<a href="<?php echo $this->config->site_url();?>admin/category">
			...
			<div class="portlet box green">
					...
					<div class="portlet-body flip-scroll">
						<table class="table table-bordered table-striped table-condensed flip-content">
							...
							<tbody>
								<?php 
									if(isset($category_data) && !empty($category_data) && count($category_data)>0) {

										$no=1;
										foreach($category_data as $d)  { ?>

											<tr <?php if($no==1) { echo 'class="start_process"'; } ?>  data-code="<?php echo $d['categoryid'] ?>" >
												<td><?php echo $no++ ;?></td>
												<td><?php echo($d['categoryid'])?></td>
												<td><?php echo($d['parentid'])?></td>
